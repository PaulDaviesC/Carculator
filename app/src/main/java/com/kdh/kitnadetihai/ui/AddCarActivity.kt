...
class AddCarActivity : BaseDrawerActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            binding.etInitialOdo.hint = "Initial odometer (${if (unit == com.kdh.kitnadetihai.data.DistanceUnit.KM) "KM" else "Mile"})"
    ...
    private fun updateAcqDateLabel() {
        binding.tvAcqDate.text = "Acquisition: " + com.kdh.kitnadetihai.util.Formatters.formatDateTime(acqDateEpochMs)
    }
}
